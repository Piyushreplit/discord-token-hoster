...
process.title = ` veiyo's Onliner Epic [Multiple Accounts] Total Accounts: ${tokens.length}`;
console.log(colors.green(`veiyo's Onliner `) + (colors.magenta(`Epic `)) + (colors.cyan(`[Multiple Accounts] `)) + (colors.red(`Total Accounts: ${tokens.length}`)));
console.log("veiyo#0006");
console.log(colors.underline(colors.green(`                        Created By veiyo#0006`)));
